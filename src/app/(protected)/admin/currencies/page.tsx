 ...
 * before rendering, mirroring `admin/users/page.tsx`. The `/api/currencies`
 * Route Handlers behind `CurrenciesTable` perform the same check again for
 * mutations, and the backend is the final authority.
 */
export default async function AdminCurrenciesPage() {
  ...
  if (!accessToken || isTokenExpired(claims)) {
    redirect('/login?redirect=/admin/currencies');
  }
